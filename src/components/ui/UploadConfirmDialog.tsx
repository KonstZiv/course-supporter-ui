    ...
    <Modal open={open} onClose={handleCancel} title="Тип документа">
      ...
      {codeActive && (
        <div className="rounded-lg bg-navy/5 border border-navy/15 p-3 mb-4 text-[12px] text-ink-muted">
          Код-матеріал: кожен ваш файл стане окремим сегментом дослівно.
          Типові й бібліотечні файли (lock-файли, <code>node_modules</code>,
          мініфіковані артефакти) та файли понад 4 МБ увійдуть лише описом у
          структурі проєкту.
        </div>
      )}
