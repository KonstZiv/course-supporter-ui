...
const INGEST_ERROR_MESSAGES: Record<string, string> = {
  ...
  charset_violation:
    'Файл збережено не в кодуванні UTF-8, і його кодування не вдалося ' +
    'надійно розпізнати. Відкрийте файл у редакторі, збережіть його як ' +
    'UTF-8 і завантажте знову.',
